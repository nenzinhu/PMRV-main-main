"""
Gera dados GPS a partir de arquivos Shapefile de rodovias.

Uso: python scripts/generate_gps_data.py

Este script:
1. Lê shapefile com geometria de rodovias (UTM Zona 22S)
2. Converte coordenadas para WGS84 (Lat/Lng) usando pyproj
3. Interpola pontos a cada 500m para equilibrar precisão e tamanho
4. Exporta como arquivo JavaScript com dados em window.GPS_RODOVIAS_SC

Configuração:
- Entrada: C:\Users\Nei\Desktop\PMRV-main\Rodovias_SC_04.24\Rodovias_SC.shp
- Saída: C:\Users\Nei\Desktop\PMRV-main\js\gps_data_sc.js
- Projeção: EPSG:31982 (SIRGAS 2000 UTM 22S) -> EPSG:4326 (WGS84)
"""
import shapefile
import json
import os
