"""
Atualiza tabela de infrações e preços vigentes.

Uso: python scripts/update_infracoes.py

Este script:
1. Lê dados de infrações comprimidos em base64
2. Atualiza preços conforme Lei 13.281/16 (vigência 2024/2025)
3. Reconstrói arquivo com dados atualizados
4. Exporta para JSON e JavaScript

Preços calibrados para tabela CNH/CTB 2024/2025
"""
import base64
import os
import csv
